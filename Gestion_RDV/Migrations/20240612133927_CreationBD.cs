        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    usr_avatar = table.Column<string>(type: "text", nullable: false),
                    usr_secret_token = table.Column<string>(type: "text", nullable: false),
                    usr_role = table.Column<string>(type: "text", nullable: false),
                    usr_sexe = table.Column<string>(type: "text", nullable: false),
                    usr_telephone = table.Column<string>(type: "text", nullable: false),
                    adr_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
